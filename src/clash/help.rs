...
impl HelpInfo {
    ...
    pub fn find_field(ecs: &World, entity: Entity) -> HelpInfo {
        ...
        HelpInfo::text_header(&ecs.get_name(entity).unwrap_or("Field".to_string()), details)
    }
    ...
    pub fn find_orb(ecs: &World, entity: Entity) -> HelpInfo {
        ...
        HelpInfo::text_header(&ecs.get_name(entity).unwrap_or("Orb Projectile".to_string()), details)
    }
}
